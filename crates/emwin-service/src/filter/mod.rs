...
pub use self::shared::{FileFilterInput, FileFilterInputError};
...
use crate::CompletedFileMetadata;
...
impl FileEventFilter {
    pub fn try_from_input(input: &FileFilterInput) -> Result<Self, FileFilterInputError> {
    ...
    pub fn matches_metadata(&self, metadata: &CompletedFileMetadata) -> bool {
